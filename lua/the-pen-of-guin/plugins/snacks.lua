...
vim.keymap.set('n', '<leader>;', function() Snacks.dashboard.open() end, { desc = 'Open Dashboard' })
...
vim.keymap.set('n', "<leader>ew", function() Snacks.explorer() end, { desc = "File Explorer at Workspace" })
vim.keymap.set('n', "<leader>ec", function() Snacks.explorer({ cwd = vim.fn.expand("%:p:h") }) end, { desc = "File Explorer at Current File" })
...
end, { desc = "File Explorer at Project Root" })
-- find
...
vim.keymap.set('n', "grtd", function() Snacks.picker.lsp_type_definitions() end, { desc = "Goto T[y]pe Definition" })
vim.keymap.set('n', "<leader>grs", function() Snacks.picker.lsp_symbols() end, { desc = "LSP Symbols" })
vim.keymap.set('n', "<leader>grS", function() Snacks.picker.lsp_workspace_symbols() end, { desc = "LSP Workspace Symbols" })
